    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center items-center p-6 sm:p-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <p className="text-base-content/60 text-center">Get started with your free account</p>

          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="form-control">
              <label className="label"><span className="label-text font-medium">Full Name</span></label>
              <div className="relative">
                <User className="size-5 absolute inset-y-0 left-0 pl-3 text-base-content/40" />
                <input type="text" className="input input-bordered w-full pl-10" placeholder="Type here....." value={formData.fullName} onChange={(e) => setFormData({ ...formData, fullName: e.target.value })} />
              </div>
            </div>
            ...
            <div className="form-control">
              ...
              <div className="relative">
                <Mail className="size-5 absolute inset-y-0 left-0 pl-3 text-base-content/40" />
                <input type="email" className="input input-bordered w-full pl-10" placeholder="Type here....." value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} />
              </div>
            </div>
            ...
            <div className="form-control">
              ...
              <div className="relative">
                <Lock className="size-5 absolute inset-y-0 left-0 pl-3 text-base-content/40" />
          ...
          <p className="text-base-content/60 text-center">Already have an account? <Link to="/login" className="link link-primary">Sign in</Link></p>
        </div>
      </div>

      {/* Right Side: Social Links */}
      <div className="flex flex-col justify-center items-center p-6 space-y-4 lg:items-end lg:pr-12">
        <p className="text-base-content/60 text-center">Development by Tushar Kanti Dey</p>
